...
//                    text: openedflag ? (minesaround === 0 ? "" : minesaround) : mark
                ...
                state: openedflag ? "opened": "unopened"
                states: [
                    State {
                        name: "unopened"
                    ...
                    State {
                        ...
                        PropertyChanges { target: marktext; text:(minesaround === 0 ? "" : minesaround); }
                    },
                    State {
                        name: "bomb"
                        PropertyChanges { target: mine; color: "red"; }
                        PropertyChanges { target: marktext; text:"*"; color:"blue";}
                    }
                ]
                MouseArea{
                    anchors.fill: parent
